...
class WishlistTileWidget extends StatelessWidget {
  ...
  const WishlistTileWidget({super.key, required this.productDataModel, required this.wishlistBlocBloc});
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        wishlistBlocBloc.add(WishlistRemoveFromWishlistEvent(productDataModel: productDataModel));
                      },
                      icon: Icon(
                        Icons.remove_circle,
                        color: Colors.black,
